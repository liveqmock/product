 ...
 * Version: 1.0
 */
public final class CheckboxesTag extends BaseTag{
    //specify which checkboxes should be checked; ',' or ';' separated Strings;
    ...
    private HashSet checkedValues = new HashSet();
    ...
    public void setChecked(String value) {
        ...
        if(value != null && value.length()>0){
            ...
            while(st.hasMoreElements()){
                checkedValues.add(st.nextToken());
            }
        }
    }
    ...
    private void writeList(JspWriter writer,List list) throws JspException,IOException{
        ...
        try{
            for(int i=0;i<count;i++){
                ...
                writer.print(code);
                writer.print("\"");
                if(checkedValues.contains(code)){
