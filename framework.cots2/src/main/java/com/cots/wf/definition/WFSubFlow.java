 ...
 * instance according to the subflow displayName. If asynExec is true,
...
public class WFSubFlow extends WFAbstractActivity {
    /**
     * the displayName of this subflow activity;
     */
    ...
    /**
     * get the displayName of the sub workflow;
     *
     * @return the displayName of the subworkflow;
     */
    ...
    /**
     * set the displayName of the sub workflow;
     *
