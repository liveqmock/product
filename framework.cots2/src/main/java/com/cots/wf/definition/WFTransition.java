...
public class WFTransition {
    ...
    /**
     * the activity displayName from which this transition goes out;
     */
    private String fromActivityName;

    /**
     * the activity displayName to wchich this transition goest into;
     */
    ...
    /**
     * se the from activity displayName;
     *
     * @param from
     */
    ...
    /**
     * set the to activity displayName;
     *
     * @param to
     */
