...
<html>
  <head>
	...
	function onClick(e,treeId, treeNode) {
		var id = treeNode.id;
		var url = "getAllScenery.?TA_SCENERY_POINT@pageNO=1&TA_SCENERY_POINT@pageSize=10&TA_SCENERY_POINT/city_id="+id;
		parent.window.sceneryTreeRight.location.href=url;
	}
