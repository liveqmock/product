...
<div id="bm-table">
 ...
 width="95%" id="hotel0">
			...
			<tr><td colspan=1 >车队名称：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxCD","cdmc",0)%>"  disabled="disabled"  /></td></tr>  
			<tr><td colspan=1>团号：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxCD","id",0)%>"  disabled="disabled"  /></td></tr>
			
			<tr><td>签单总计：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxCD","qdje",0) %>"  disabled="disabled" />/元</td></tr>
			<tr><td>已清签单：</td><td><input type="text"  id="yq" value="<%=rd.getStringByDI("selectBxCD","hkje",0) %>"  disabled="disabled"  />/元</td></tr>
			<tr>
				<td>
				<font color="red">剩余签单款：</font></td><td><input type="text"  id="qd" value="<%=rd.getStringByDI("selectBxCD","ye",0) %>" disabled="disabled" class="qdxj" />/元
				</td>
			</tr>
			<tr>	
				<td><font color="red">本次结算金额：</font></td><td><input type="text"  name="TA_DJ_QDQKJL4VEH/HKJE[0]" value="<%=rd.getStringByDI("selectBxCD","ye",0) %>" id="xf" onkeydown="checkNumX()" onkeyup="sumRs()"  class="xfxj"/>/元
				</td>		
			</tr>
			<tr >
				<td><font color="red">余额：</font></td><td><input type="text" name="TA_DJ_QDQKJL4VEH/YE[0]" value="0" disabled="disabled" id="ye" class="yue" />/元
				</td>
			</tr>
