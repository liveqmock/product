...
<div id="bm-table">
 ...
 collapse;table-layout:fixed;width:441pt'>
  ...
  height:14.25pt'>车队名称：</td><td colspan=5 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("cdlist","cdmc",0)%></td>
 </tr>
  <tr height=25 style='mso-height-source:userset;height:20pt'>
  <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>签单总计：</td>
  <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("cdlist","qdje",0) %>(元)</td>
   <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>团号：</td>
  <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("cdlist","tid",0)%></td>
 </tr>
				
			<%
		int rows = rd.getTableRowsCount("cdlist");
		for(int i=0;i<rows;i++) {
			String hkje=rd.getStringByDI("cdlist","hkje",i);
			String czrq=rd.getStringByDI("cdlist","czrq",i);
			String ye=rd.getStringByDI("cdlist","ye",i);
		...
		%>
			...
			<tr height=25 style='height:20pt'>
  			...
  			<td class=xl49  class=xl49 style='border-right:.5pt solid black;border-left:none'><%=czrq %></td>
 		</tr>
