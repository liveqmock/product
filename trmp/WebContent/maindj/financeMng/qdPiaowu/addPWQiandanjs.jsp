...
$(function(){
	...
	function addPWQD(){
		...
		{
		jQuery("#ye").val((parseFloat(qd-xf)).toFixed(2));
		document.qiandan_form.action="adddjPWqingdan.";
...
<div id="bm-table">
 ...
 width="95%" id="hotel0">
			...
			<tr><td colspan=1 >代购点名称：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxPW","dgdmc",0)%>"  readonly="readonly"  /></td></tr>  
			<tr><td colspan=1 >团号：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxPW","id",0)%>"  readonly="readonly"  /></td></tr>
			
			<tr><td>签单总计：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxPW","qd",0) %>"  readonly="readonly"  />/元</td></tr>
			...
			<tr>	
				<td><font color="red">现付金额：</font></td><td><input type="text" value="<%=rd.getStringByDI("selectBxPW","ye",0) %>" name="TA_DJ_QDQKJL4PW/HKJE[0]" id="xf" onkeydown="checkNumX()" onkeyup="sumRs()"  class="xfxj"/>/元
				</td>		
			</tr>
			<tr >
				<td><font color="red">余额：</font></td><td><input type="text" name="TA_DJ_QDQKJL4PW/YE[0]" value="0" readonly="readonly" id="ye" class="yue" />/元
				</td>
			</tr>

			<input type="hidden" name="TA_DJ_QDQKJL4PW/TID[0]" value="<%=rd.getStringByDI("selectBxPW","id",0)%>"/>
			<input type="hidden" name="TA_DJ_QDQKJL4PW/DGDID[0]" value="<%=rd.getStringByDI("selectBxPW","dgd",0)%>"/>
			<input type="hidden" name="TA_DJ_QDQKJL4PW/CZR[0]" value="<%=sd.getString("userno") %>"/>	
  </table>
