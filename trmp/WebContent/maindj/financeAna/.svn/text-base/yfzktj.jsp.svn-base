...
<script type="text/javascript">
	...
	function reportsHotel(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/dj/qdtj/qdHotel.rptdesign&groupID="+groupID+
	...
	function reportsVeh(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/dj/qdtj/qdVeh.rptdesign&groupID="+groupID+
	...
	function reportsTicket(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/dj/qdtj/qdTicket.rptdesign&groupID="+groupID+
	...
	function reportsCT(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/dj/qdtj/qdCt.rptdesign&groupID="+groupID+
	...
	function reportsJD(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/dj/qdtj/qdScenery.rptdesign&groupID="+groupID+
	...
	function reportsNextTra(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/dj/qdtj/qdNextTra.rptdesign&groupID="+groupID+
