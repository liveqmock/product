...
<div id="list-table">
	<table class="datas" >
		...
		<tr>
			...
			<td><%=END_DATE %></td>
			<td>
				<a href="<%=request.getContextPath() %>/maindj/bx/printCwjsd/showBxGroupPrint.?TA_DJ_GROUP/ID=<%=ID %>&TA_TDJDXXZJB/TID=<%=ID %>&groupID=<%=ID %>&TID=<%=ID %>"><img alt="" src="<%=request.getContextPath() %>/images/Print.gif">&nbsp;[打印财务结算单]</a>
			</td>
		</tr>
		<%} %>
	</table>
...
<div id="page">
	<%String url=request.getContextPath()+"/maindj/maindj/bx/printCwjsd/bxPrintList.?pageSize=10&pageNO=";%>
