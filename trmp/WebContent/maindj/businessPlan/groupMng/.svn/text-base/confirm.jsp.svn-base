...
<%
String ztsmc = rd.getStringByDI("rsTravels","ztsmc",0);
String ztsid = rd.getStringByDI("rsTravels","ztsid",0);
String tztsID = rd.getStringByDI("rsTravels","tztsKey",0);
%>
<html>
<head>
	...
	<script type="text/javascript">
		$(function() {
			$('#custom_file_upload').uploadify({
				  ...
				  'script'         : '<%=request.getContextPath()%>/maindj/businessPlan/groupMng/addConfirm.fu',
