...
<%
	...
	Object objBD = rd.get("TA_DJ_GROUPs", "BEGIN_DATE", 0);
	date = (java.util.Date)objBD;
...
<table class="datas">
	...
	<tr>
		<td colspan="3" align="center"><br><input type="button"  value="返    回" onclick="window.history.go(-1)"/><br><br></td>
	</tr>
</table>
</div>
