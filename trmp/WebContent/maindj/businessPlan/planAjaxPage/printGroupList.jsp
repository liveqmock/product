...
<div id="list-table">
	<table class="datas" >
		...
		<tr>
			...
			<td><%=END_DATE %></td>
			<td>
				<a href="<%=request.getContextPath() %>/maindj/businessPlan/plan/printGroupPlan/showGroupPrint.?TA_DJ_GROUP/ID=<%=ID %>&TA_DJ_GROUP/orgid=<%=orgid %>&TA_TDJDXXZJB/TID=<%=ID %>&TA_TDJDXXZJB/orgid=<%=orgid %>&id=<%=ID %>"><img alt="" src="<%=request.getContextPath() %>/images/Print.gif">&nbsp;[打印出团任务单]</a>
			</td>
		</tr>
		<%} %>
	</table>
