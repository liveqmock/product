...
// Create the tree
function createTree(arrName, startNode, openNode,baseName) {
	nodes = arrName;
	if (nodes.length > 0) {
		preloadIcons();
		...
		if (startNode !=0) {
			...
			document.write("<a href=\"" + nodeValues[3] + "\" target=\"" + nodeValues[4] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"../../images/tree/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
		} else document.write("<img src=\"../../images/tree/base.gif\" align=\"absbottom\" alt=\"\" />"+baseName+"<br />");
	...
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				...
				if (ls) document.write("<img src=\"../../images/tree/join.gif\" align=\"absbottom\" alt=\"\" />");
				else document.write("<img src=\"../../images/tree/joinbottom.gif\" align=\"absbottom\" alt=\"\" />");
			}
