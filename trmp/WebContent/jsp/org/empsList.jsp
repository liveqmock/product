...
员工姓名：	<input type="text" name="empname" size="16" maxlength="16" >
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="hci">
    ...
    <tr class="content" > 
      ...
      <td width="12%"><%=rd.getStringByDI("HREMPLOYEEs","empname",i)%>&nbsp;</td>
      <td width="10%"><%if("1".equals(rd.getStringByDI("HREMPLOYEEs","sex",i)))out.print("男");else{out.print("女");}%></td>
      <td width="21%"><%=rd.getStringByDI("HREMPLOYEEs","orgName",i)%>&nbsp;</td>
...
<div id="page">
	<%String url="getContactList.?DispMode=U&HREMPLOYEE/ORGID="+rd.getStringByDI("HREMPLOYEE","orgid",0)+"&HREMPLOYEE@pageSize=10&HREMPLOYEE@pageNO=";%>
