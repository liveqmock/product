...
<script type="text/javascript">
	...
	function reportsShop(){

		var groupID = jQuery("#groupID").val();
		var dateB = jQuery("#dateB").val();
		var dateE = jQuery("#dateE").val();
		var shopNm = jQuery("#shopNm").val();
		var qkzt = jQuery("#qkzt").val();
		
		window.open("<%=request.getContextPath() %>/frameset?__report=report/zt/ztreserve/ztreserveOfShop.rptdesign&groupID="+groupID+
				"&db="+dateB+"&de="+dateE+"&qkzt="+qkzt+"&shopNm="+shopNm,'obj','width=900, height=700, top=0, left=270, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no');
	...
	<div id="tabs-1">
	  <table class="datas" width="90%">
		...
		<tr>
		  ...
		  <td>购物点名称：</td>
		  <td><input type="text" id="shopNm"></input></td>
		</tr>
		<tr>
		<td>留存清款状态：</td>
		  <td>
			...
			<td colspan="2" align="center">
				<a href="###" onclick="reportsShop();"><img alt="搜索" src="<%=request.getContextPath()%>/images/search.gif"/></a>
			</td>
		</tr>
	  </table>
	</div>
