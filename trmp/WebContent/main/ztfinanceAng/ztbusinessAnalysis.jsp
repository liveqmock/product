...
<script type="text/javascript">
	...
	function reportsCount(){
		...
		window.open("<%=request.getContextPath() %>/frameset?__report=report/zt/ztprofit/ztbusinessAnalysis.rptdesign"+
...
<div id="tabs">
	...
	<div id="tabs-1">
  	...
  	<option value="" >***请选择***</option>
  			<%
					for(int j=0;j<rd.getTableRowsCount("getztBusinessName");j++){
					String no = rd.getString("getztBusinessName","userno",j);
					String name = rd.getString("getztBusinessName","username",j);				
			%>
