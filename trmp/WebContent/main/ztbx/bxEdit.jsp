...
<table class="datas" >
		...
		<tr>
			...
			<td >成人:<%=rd.getStringByDI("bx_GuideInfo","ADULT_COUNT",0) %>人&nbsp;儿童:<%=rd.getStringByDI("bx_GuideInfo","CHILDREN_COUNT",0) %>人&nbsp;</td>
		...
		<tr>
			...
			<td>
				全陪人数:<%=rd.getStringByDI("TA_ZT_GROUPs","QPRS",0) %>&nbsp;
		...
		<table class="datas">
			...
			<tr>
			<td>导游尚未报账(<span class="showPointer" style="text-decoration:underline;color:red;font-weight:100" onclick="return GB_myShow('导游费用报账','<%=request.getContextPath()%>/main/ztbx/bxGuide/ztInitGuideRbt.?TA_ZT_BXDY/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=init','800','750','')">申请报账</span>)</td>
			</tr>
		</table>
		<%
		}}else{
		...
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
				<td><span>导游费用信息</span>&nbsp;&nbsp;<span class="showPointer" onclick="return GB_myShow('导游费用报账','<%=request.getContextPath() %>/main/ztbx/bxGuide/ztInitGuideRbt.?TA_ZT_BXDY/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=view','800','650','')">查看报账明细</span></td>
			<%}else{ %>
				<td><span>导游费用信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('导游费用报账','<%=request.getContextPath() %>/main/ztbx/bxGuide/ztInitGuideRbt.?TA_ZT_BXDY/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=edit','800','750','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
				<td align="right">
					导游费用合计:导游领款合计:<font color="red"><%=dylk %></font>元    导服费合计:<font color="red"><%=dff %></font>元 导游交通费合计:<font color="red"><%=dyjtf %></font>元&nbsp;其它费用:<font color="red"><%=qt %></font>元&nbsp;导游费用合计:<font color="red"><%=rd.getStringByDI("TA_TDBXZJXXB_ZTs","DYFYHJ",0) %></font>元&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
			</tr>
	...
	%>
		<table class="datas">
			...
			<tr>
				<td>酒店尚未报账(<span class="showPointer" style="text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('酒店费用报账','<%=request.getContextPath()%>/main/ztbx/bxHotel/ztinitDjHotelBx.?TA_ZT_GROUP/ID=<%=ID%>&TA_ZT_BXHOTEL/TID=<%=ID %>&TID=<%=ID %>&flag=init','800','750','')">申请报账</span>)</td>
			</tr>
		</table>
	<%}}else{ %>
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
				<td><span>酒店报帐信息</span>&nbsp;&nbsp;<span class="showPointer" onclick="return GB_myShow('酒店费用报账','<%=request.getContextPath()%>/main/ztbx/bxHotel/ztinitDjHotelBx.?TA_ZT_GROUP/ID=<%=ID%>&TA_ZT_BXHOTEL/TID=<%=ID %>&TID=<%=ID %>&flag=view','800','750','')">查看报账明细</span></td>
			<%}else{ %>
				<td><span>酒店报帐信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('酒店费用报账','<%=request.getContextPath()%>/main/ztbx/bxHotel/ztinitDjHotelBx.?TA_ZT_GROUP/ID=<%=ID%>&TA_ZT_BXHOTEL/TID=<%=ID %>&TID=<%=ID %>&flag=edit','800','750','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
				<td align="right">
	...
	<div id="dinnerDiv">
		...
		<table class="datas">
			...
			<tr>
				<td>餐厅尚未报账(<span class="showPointer" style="text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('餐厅费用报账','<%=request.getContextPath()%>/main/ztbx/bxRestaurant/ztinitDjDinnerBx.?TA_ZT_GROUP/ID=<%=ID%>&TA_ZT_BXCT/TID=<%=ID %>&TID=<%=ID %>&flag=init','800','680','')">申请报账</span>)</td>
			</tr>
		</table>
		<%}}else{ %>
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>餐厅报帐信息</span>&nbsp;&nbsp;<span class="showPointer" onclick="return GB_myShow('餐厅费用报账','<%=request.getContextPath()%>/main/ztbx/bxRestaurant/ztinitDjDinnerBx.?TA_ZT_GROUP/ID=<%=ID%>&TA_ZT_BXCT/TID=<%=ID %>&TID=<%=ID %>&flag=view','800','680','')">查看报账明细</span></td>
			<%}else{ %>
			<td><span>餐厅报帐信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('餐厅费用报账','<%=request.getContextPath()%>/main/ztbx/bxRestaurant/ztinitDjDinnerBx.?TA_ZT_GROUP/ID=<%=ID%>&TA_ZT_BXCT/TID=<%=ID %>&TID=<%=ID %>&flag=edit','800','680','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
				<td align="right">
	...
	%>
		<table class="datas">
			...
			<tr>
				<td>票务尚未报帐(<span class="showPointer" style="text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('票务报账','<%=request.getContextPath()%>/main/ztbx/bxTicket/ztInitTicketBx.?TA_ZT_BXPW/TID=<%=ID %>&TA_ZT_JHPW/TID=<%=ID %>&dmsm/JTGJ=2&flag=init','800','850','')">申请报账</span>)</td>
			</tr>
		</table>
	<%}}else{ %>
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>票务报帐信息</span>&nbsp;&nbsp;<span class="showPointer"  onclick="return GB_myShow('票务报账','<%=request.getContextPath()%>/main/ztbx/bxTicket/ztInitTicketBx.?TA_ZT_BXPW/TID=<%=ID %>&TA_ZT_JHPW/TID=<%=ID %>&dmsm/JTGJ=2&flag=view','800','850','')">查看报账明细</span></td>
			<%}else{ %>
			<td><span>票务报帐信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('票务报账','<%=request.getContextPath()%>/main/ztbx/bxTicket/ztInitTicketBx.?TA_ZT_BXPW/TID=<%=ID %>&TA_ZT_JHPW/TID=<%=ID %>&dmsm/JTGJ=2&flag=edit','800','850','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
				<td align="right">
	...
	%>
		<table class="datas">
			...
			<tr>
				<td>车辆尚未报账(<span class="showPointer" style="text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('车辆报账','<%=request.getContextPath()%>/main/ztbx/bxCar/ztInitVehBx.?TA_ZT_JHCL/TID=<%=ID %>&TA_ZT_BXCL/TID=<%=ID %>&flag=init','800','850','')">申请报账</span>)</td>
			</tr>
		</table>
	<%}}else{ %>
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>车辆报账信息</span>&nbsp;&nbsp;<span class="showPointer" onclick="return GB_myShow('车辆报账','<%=request.getContextPath()%>/main/ztbx/bxCar/ztInitVehBx.?TA_ZT_JHCL/TID=<%=ID %>&TA_ZT_BXCL/TID=<%=ID %>&flag=view','800','850','')">查看报账明细</span></td>
			<%}else{ %>
			<td><span>车辆报账信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('车辆报账','<%=request.getContextPath()%>/main/ztbx/bxCar/ztInitVehBx.?TA_ZT_JHCL/TID=<%=ID %>&TA_ZT_BXCL/TID=<%=ID %>&flag=edit','800','850','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
	...
	%>
		<table class="datas">
			...
			<tr>
				<td>地接尚未报账(<span class="showPointer" style="text-decoration:underline;color:red;font-weight:100" onclick="return GB_myShow('地接社报账','<%=request.getContextPath()%>/main/ztbx/bxGroundTrave/ztInitdjsInfo.?TA_ZT_BXDJ/TID=<%=ID %>&flag=init','800','600')">申请报账</span>)</td>
			</tr>
		</table>
	<%
	}}else{
	...
	<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>地接报账信息</span>&nbsp;&nbsp;<span class="showPointer"  onclick="return GB_myShow('地接社报账','<%=request.getContextPath()%>/main/ztbx/bxGroundTrave/ztInitdjsInfo.?TA_ZT_BXDJ/TID=<%=ID %>&flag=view','800','600')">查看报账明细</span></td>
			<%}else{ %>
			<td><span>地接报账信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('地接社报账','<%=request.getContextPath()%>/main/ztbx/bxGroundTrave/ztInitdjsInfo.?TA_ZT_BXDJ/TID=<%=ID %>&flag=edit','800','600')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
	...
	%>
		<table class="datas">
			...
			<tr>
				<td>景点尚未报账(<span class="showPointer" style="text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('查看景点报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitSceneryRbt.?TA_ZT_BXJD/TID=<%=ID %>&flag=init','800','700','')">申请报账</span>)</td>
			</tr>
		</table>
		<%}}else{ %>
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>景点报账信息</span>&nbsp;&nbsp;<span class="showPointer" onclick="return GB_myShow('查看景点报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitSceneryRbt.?TA_ZT_BXJD/TID=<%=ID %>&flag=view','800','700','')">查看报账明细</span></td>
			<%}else{ %>
			<td><span>景点报账信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('查看景点报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitSceneryRbt.?TA_ZT_BXJD/TID=<%=ID %>&flag=edit','800','700','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
	...
	<%
		...
		String ADULT_COUNT = rd.getStringByDI("bx_GuideInfo","ADULT_COUNT",0);
	...
	%>
		<table class="datas">
			<tr>
				<td><span>购物报账信息</span>(<span class="showPointer" style="text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('查看购物报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitShopRbt.?TCCY=18&LCBL=21&TA_ZT_BXGW/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=init&qprszt=<%=QPRSZT %>&CRRS=<%=ADULT_COUNT %>','800','700','')">申请报账</span>)</td>
			</tr>
			<tr>
				<td></td>
			</tr>
		...
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>购物报账信息</span><span class="showPointer"  onclick="return GB_myShow('查看购物报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitShopRbt.?TCCY=18&LCBL=21&TA_ZT_BXGW/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=view&qprszt=<%=QPRSZT %>&CRRS=<%=ADULT_COUNT %>','800','700','')">&nbsp;&nbsp;查看报账明细</span></td>
			<%}else{ %>
			<td><span>购物报账信息</span>(<span class="showPointer" style="text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('查看购物报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitShopRbt.?TCCY=18&LCBL=21&TA_ZT_BXGW/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=edit&qprszt=<%=QPRSZT %>&CRRS=<%=ADULT_COUNT %>','800','700','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
	...
	%>
		<table class="datas">
			<tr>
				<td><span>加点报账信息</span>(<span class="showPointer" style=" text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('查看加点报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitPlusRbt.?TCCY=18&LCBL=21&TA_ZT_BXJIADIAN/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=init&qprszt=<%=QPRSZT %>','800','700','')">申请报账</span>)</td>
			</tr>
			<tr>
				<td></td>
			</tr>
		...
		<table class="datas">
			<tr>
			<%if(isTrue){ %>
			<td><span>加点报账信息</span>&nbsp;&nbsp;<span class="showPointer" onclick="return GB_myShow('查看加点报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitPlusRbt.?TCCY=18&LCBL=21&TA_ZT_BXJIADIAN/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=view&qprszt=<%=QPRSZT %>','800','700','')">查看报账明细</span></td>
			<%}else{ %>
			<td><span>加点报账信息</span>(<span class="showPointer" style=" text-decoration:underline; color:blue;font-weight:100" onclick="return GB_myShow('查看加点报账信息','<%=request.getContextPath() %>/main/ztPlans/sceneryPlan/ztInitPlusRbt.?TCCY=18&LCBL=21&TA_ZT_BXJIADIAN/TID=<%=ID %>&TA_TDBXZJXXB_ZT/TID=<%=ID %>&flag=Edit&qprszt=<%=QPRSZT %>','800','700','')">修改报账</span>)</td>
			<%} %>
			</tr>
			<tr>
			...
			<tr>
				<td  align="right">费用合计：签单金额合计：<font color="red"><%="".equals(rd.getString("TA_TDBXZJXXB_ZTs","JDQDHJ",0))?0:rd.getString("TA_TDBXZJXXB_ZTs","JDQDHJ",0) %></font>元&nbsp;&nbsp;&nbsp;&nbsp;现付金额合计：<font color="red"><%="".equals(rd.getString("TA_TDBXZJXXB_ZTs","JDXFHJ",0))?0:rd.getString("TA_TDBXZJXXB_ZTs","JDXFHJ",0) %></font>元&nbsp;&nbsp;&nbsp;&nbsp;人数合计：<font color="red"><%="".equals(rd.getString("TA_TDBXZJXXB_ZTs","JDRSHJ",0))?0:rd.getString("TA_TDBXZJXXB_ZTs","JDRSHJ",0) %></font>人&nbsp;&nbsp;&nbsp;&nbsp;人头费合计：<font color="red"><%="".equals(rd.getString("TA_TDBXZJXXB_ZTs","JDRTFHJ",0))?0:rd.getString("TA_TDBXZJXXB_ZTs","JDRTFHJ",0) %></font>元&nbsp;&nbsp;&nbsp;&nbsp;成本合计：<font color="red"><%="".equals(rd.getString("TA_TDBXZJXXB_ZTs","JDCBHJ",0))?0:rd.getString("TA_TDBXZJXXB_ZTs","JDCBHJ",0) %></font>元&nbsp;&nbsp;&nbsp;&nbsp;净利合计：<font color="red"><%="".equals(rd.getString("TA_TDBXZJXXB_ZTs","JDLRHJ",0))?0:rd.getString("TA_TDBXZJXXB_ZTs","JDLRHJ",0) %></font>元&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<%}} %>
	</div>
	<div id="SumPrice">
		<table class="datas">
			...
			<%
				...
				String GWLRHJ = rd.getString("TA_TDBXZJXXB_ZTs","GWLRHJ",0);//购物利润合计
				Float gwlrhjs=GWLRHJ.length()>0?Float.parseFloat(GWLRHJ):0;
				String GWYJGSHJ = rd.getString("TA_TDBXZJXXB_ZTs","GWYJGSHJ",0);//购物应交公司
				...
				Float dffs=dff.length()>0?Float.parseFloat(dff):0;
				//司陪住宿费
				...
				//成本支出 酒店成本支出已经包含师陪住宿
				Float cbzc= jdhjs+cthjs+pwhjs+clhjs+jindhjs+djhjs+dffs;
				Float cbqd= jdqds+ctqds+pwqds+clqds+sceneryqds+djsqds;
				Float cbxf= jdxfs+ctxfs+pwxfs+clxfs+sceneryxfs+djxf;
				//团队利润 = 订单应收款 - 合计 + 公司留存 + 购物利润合计  + 购物人头费 + 加点人头费 + 加点利润合计  
				Float TDLR = ddysks - cbzc  + gwlrhjs+ gwgslchjs + jdlrhjs +jdrtfhjs;
				
				Float zmml = ddysks - cbzc;
			%>
			<tr>
				<td>
					订单应收款：<font color="red"><%=ddysks %></font>&nbsp;&nbsp;&nbsp;&nbsp;
					签单金额总计：<font color="red"><%=cbqd %></font>元&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="hidden" name="TA_TDBXZJXXB_ZT/ZCQDXJ" value="<%=cbqd %>"/>
					现付金额总计：<font color="red"><%=cbxf %></font>元&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="hidden" name="TA_TDBXZJXXB_ZT/ZCXFXJ" value="<%=cbxf %>"/>
					支出合计：<font color="red"><%=cbzc %></font>元
					<input type="hidden" name="TA_TDBXZJXXB_ZT/ZCFYHJ" value="<%=cbzc %>"/>
	...
	<div>
		<table class="datas">
			<tr>
				<td  colspan="2"><span>审批意见</span>&nbsp;&nbsp;&nbsp;&nbsp;<%String USERID = sd.getString("USERID"); if("admin".equals(USERID)||"ywbzg".equals(USERID)||"lkj".equals(USERID)||"ywy".equals(USERID)){%><span class="showPointer" style=" text-decoration:underline; color:red;font-weight:100" onclick="return GB_myShow('查看数据对比信息','<%=request.getContextPath()%>/main/ztbx/bxSh/ztBxBJ.?TID=<%=rd.getStringByDI("bx_GuideInfo","ID",0) %>'),'500','400',''">数据对比&nbsp;</span><img src="<%=request.getContextPath()%>/images/Contrast.gif" height="16" width="16"  class="showPointer" onclick="return GB_myShow('查看加点报账信息','<%=request.getContextPath()%>/main/ztbx/bxSh/ztBxBJ.?TID=<%=rd.getStringByDI("bx_GuideInfo","ID",0) %>'),'500','400',''"/><%} %></td>
			</tr>
...
<script type="text/javascript">
	...
	function bxShSub(){
		if(<%=newTraverows%>>0 && <%=bxHotelRows%>>0 && <%=bxDinnerRows%>>0 && <%=bxTicketRows%>>0 && <%=bxCarRows%>>0 && <%=djsRows%>>0 && <%=sceneryRows%>>0 && <%=shopRows%>>0 && <%=plusRows%>>0){
			document.bxBJ_form.action="ztInitShBxList.?pageNO=1&pageSize=10&definitionid=ztbxsh&TID=<%=ID %>";
	...
	function bxShSub(){
		document.bx_group_form.action="ztInitShBxList.?pageNO=1&pageSize=10&definitionid=ztbxsh&TID=<%=ID %>";
