	...
	jQuery("#addHotel").click(function(){
		 ...
		 jQuery("#hotelDiv").append('<table class="datas select-hotel" width="95%" id="hotel'+num+'">'+
				...
				'<tr><td colspan="4">请选择酒店：'+
		           ...
		           '<select name="TA_ZT_BXHOTEL/JDID['+num+']" class="hotelid" id="id_hotel'+num+'" USEDATA="dataSrc'+d+'" SUBCLASS="5" onchange="getHotelInfo(this.value,\'hotelInfo'+num+'\')"></select>'+
		           '</td></tr>'+
		           '<tr><td colspan="4">'+
				   ...
				   '&nbsp; <font color="red">含打包早</font><input type="checkBox" value="3" name="TA_ZT_BXHOTEL/SFHZ['+num+']" onclick="checkBoxNum(this);"/>'+
				   '入住时间：<input type="text" name="TA_ZT_BXHOTEL/RZ_TIME['+num+']" onFocus="WdatePicker({startDate:\'%y-%M-%d %H:%m:%s\',dateFmt:\'yyyy-MM-dd HH:mm:ss\',alwaysUseStartDate:true});"/>'+
					'入住天数：<input type="text" name="TA_ZT_BXHOTEL/TS['+num+']" onkeydown="checkNum()" class="smallInput ts" onchange="SumPrice()"/>'+
					'司陪住宿：<input type="text" name="TA_ZT_BXHOTEL/SFZSF['+num+']" onkeydown="checkNum()" class="smallInput spzsf" onchange="SumPrice()"/>'+
				   '</td></tr>'+
...
<div id="bm-table">
	...
	<table class="datas select-hotel" width="95%" id="hotel<%=i %>">
			...
			<tr>
			  <td colspan="4">请选择酒店：
			 	<select name="TA_ZT_BXHOTEL/SF[<%=i %>]" id="pro<%=i %>" USEDATA="dataSrc<%=i %>" SUBCLASS="1"></select>
			  	...
			  	<select name="TA_ZT_BXHOTEL/JDID[<%=i %>]" class="hotelid" id="id_hotel<%=i %>" USEDATA="dataSrc<%=i %>" SUBCLASS="5" onchange="getHotelInfo(this.value,'hotelInfo<%=i %>')"></select>
			  </td>
			</tr>
			<tr>
			  <td colspan="4">
				...
				&nbsp;入住天数：<input type="text" name="TA_ZT_BXHOTEL/TS[<%=i %>]" value="<%=rd.getStringByDI("hotelBxList","TS",i)%>" onkeydown="checkNum()" class="smallInput ts" onchange="SumPrice()"/>
				&nbsp;司陪住宿：<input type="text" name="TA_ZT_BXHOTEL/SFZSF[<%=i %>]" value="<%=rd.getStringByDI("hotelBxList","SFZSF",i)%>" onkeydown="checkNum()" class="smallInput spzsf" onchange="SumPrice()"/>
			  </td>
			</tr>
			<tr >
			...
			<tr>
				<td  colspan="4">
				          备注：<textarea rows="" cols="90" name="TA_ZT_BXHOTEL/BZ[<%=i %>]"><%=rd.getStringByDI("hotelBxList","BZ",i)%></textarea>
				</td>
			</tr>
		<tr>
			<td align="right" colspan="4">
			<font color="red">签单小计金额：</font><input type="text" value="<%=rd.getStringByDI("hotelBxList","QDXJ",i) %>" name="TA_ZT_BXHOTEL/QDXJ[<%=i %>]" onkeydown="checkNum()" class="smallInput qdxj" onchange="sumRs()"/ >/元&nbsp;&nbsp;&nbsp;
			<font color="red">现付小计金额：</font><input type="text" value="<%=rd.getStringByDI("hotelBxList","XFXJ",i) %>" name="TA_ZT_BXHOTEL/XFXJ[<%=i %>]"  readonly="readonly" class="smallInput xfxj"/>/元&nbsp;&nbsp;&nbsp;
			<font color="red">共计：</font>   <input  type="text" value="<%=rd.getStringByDI("hotelBxList","HJ",i) %>"  name="TA_ZT_BXHOTEL/HJ[<%=i %>]" readonly="readonly" class="smallInput gj"/>/元
			</td>
		</tr>
  	...
  	<table class="datas select-hotel" width="95%" id="hotel0">
			...
			<tr>
			  <td colspan="4">请选择酒店：
			  	...
			  	<select name="TA_ZT_BXHOTEL/JDID[0]" class="hotelid" id="id_hotel0" USEDATA="dataSrc0" SUBCLASS="5" onchange="getHotelInfo(this.value,'hotelInfo0')"></select>
			  </td>
			</tr>
			<tr>
			  <td colspan="4">
				...
				&nbsp;入住天数：<input type="text" name="TA_ZT_BXHOTEL/TS[0]" onkeydown="checkNum()" class="smallInput ts" onchange="SumPrice()"/>
				&nbsp;司陪住宿：<input type="text" name="TA_ZT_BXHOTEL/SFZSF[0]" class="smallInput spzsf" onchange="SumPrice()"/>
			  </td>
			</tr>
			<tr >
			...
			<tr>
				<td  colspan="4">
				          备注：<textarea rows="" cols="90" name="TA_ZT_BXHOTEL/BZ[0]"> </textarea>
				</td>
			</tr>
		<tr>
			<td align="right" colspan="4">
			<font color="red">签单小计金额：</font><input type="text" value="0" name="TA_ZT_BXHOTEL/QDXJ[0]" onkeydown="checkNum()" class="smallInput qdxj" onchange="sumRs()"/ >/元&nbsp;&nbsp;&nbsp;
			<font color="red">现付小计金额：</font><input type="text" value="0" name="TA_ZT_BXHOTEL/XFXJ[0]"  readonly="readonly" class="smallInput xfxj"/>/元<br/>
			<font color="red">共计：</font>   <input  type="text" value="0"  name="TA_ZT_BXHOTEL/HJ[0]" readonly="readonly" class="smallInput gj"/>/元
			</td>
		</tr>
...
<table class="datas" style="margin-top: 3px;">
	...
	<tr>
		<td align="right">
			<font color="red">签单金额总计：</font><input name="TA_TDBXZJXXB_ZT/BXJDQD" value="<%="".equals(qdzj)?"0":qdzj %>"  type="text" id="qiandan" readonly="readonly" class="smallInput"/>/元&nbsp;&nbsp;&nbsp;
			<font color="red">现付金额总计：</font><input name="TA_TDBXZJXXB_ZT/BXJDXF" value="<%="".equals(xfzj)?"0":xfzj %>"  type="text" id="xianfu" readonly="readonly" name="xfzj" class="smallInput"/>/元&nbsp;&nbsp;&nbsp;
			<font color="red">总计：</font>   <input name="TA_TDBXZJXXB_ZT/JDHJ" type="text" value="<%="".equals(zj)?"0":zj %>" readonly="readonly" id="zongji" class="smallInput"/>/元
		</td>
	</tr>
</table>
</div>
