...
<div id="bm-table">
 ...
 collapse;table-layout:fixed;width:441pt'>
  ...
  height:14.25pt'>代购点名称：</td>
    <td colspan=5 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("pwlist","cmpny_name",0)%></td>
 </tr>
  <tr height=25 style='mso-height-source:userset;height:20pt'>
  <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>签单总计：</td>
    <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("pwlist","qdxj",0) %></td>
   <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>团号：</td>
    <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("pwlist","tid",0)%></td>
 </tr>
				
			<%
		int rows = rd.getTableRowsCount("pwlist");
		for(int i=0;i<rows;i++) {
			String qdxj = rd.getStringByDI("pwlist","qdxj",i);//签单小计
			String hkje=rd.getStringByDI("pwlist","hkje",i);
			String czrq=rd.getStringByDI("pwlist","czrq",i);
			String ye=rd.getStringByDI("pwlist","ye",i);
