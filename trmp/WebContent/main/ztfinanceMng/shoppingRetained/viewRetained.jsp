...
<div id="bm-table">
 ...
 collapse;table-layout:fixed;width:441pt'>
  ...
  height:14.25pt'>购物点名称：</td>
  <td colspan=5 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("lcshoplist","cmpny_name",0)%></td>
 </tr>
  <tr height=25 style='mso-height-source:userset;height:20pt'>
  <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>签 单 总 计：</td>
  <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("lcshoplist","gslcxj",0) %>元</td>
   <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;height:14.25pt'>团  号：</td>
  <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("lcshoplist","tid",0)%></td>
 </tr>
				
			<%
		int rows = rd.getTableRowsCount("lcshoplist");
		for(int i=0;i<rows;i++) {
			String hkje=rd.getStringByDI("lcshoplist","bcqkje",i);
			String czrq=rd.getStringByDI("lcshoplist","czrq",i);
			String ye=rd.getStringByDI("lcshoplist","ye",i);

		%>
			
			<tr height=25 style='height:20pt'>
  			<td class=xl25 >已清留存金额：</td>
