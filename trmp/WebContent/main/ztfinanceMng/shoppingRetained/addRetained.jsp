...
<script type="text/javascript">
	...
	function addlcsh(){
		...
		{
		jQuery("#ye").val(parseInt(qd-xf));
		document.qiandan_form.action="addLcShop.";
...
<div id="bm-table">
 ...
 width="95%" id="hotel0">
			...
			<tr>	
				<td><font color="red">现付金额：</font></td><td><input type="text" value="" name="TA_ZT_LC4SHOP/BCQKJE[0]" id="xf" onkeydown="checkNum()" onchange="sumRs()"  class="xfxj"/>/元
				</td>		
			</tr>
			<tr >
				<td><font color="red">余额：</font></td><td><input type="text" value="" name="TA_ZT_LC4SHOP/YE[0]" value="" readonly="readonly" id="ye" class="yue" />/元
				</td>
			</tr>
			<tr >
				<td colspan="">
			<input type="hidden" name="TA_ZT_LC4SHOP/TID[0]" value="<%=rd.getStringByDI("selectlcShop","tid",0)%>"/>
			<input type="hidden" name="TA_ZT_LC4SHOP/SFID[0]" value="<%=rd.getStringByDI("selectlcShop","sfid",0)%>"/>
			<input type="hidden" name="TA_ZT_LC4SHOP/CSID[0]" value="<%=rd.getStringByDI("selectlcShop","csid",0)%>"/>
			<input type="hidden" name="TA_ZT_LC4SHOP/GWDID[0]" value="<%=rd.getStringByDI("selectlcShop","gwdid",0)%>"/>
			<input type="hidden" name="TA_ZT_LC4SHOP/CZR[0]" value="<%=sd.getString("userno") %>"/>	
				</td>
			</tr>
