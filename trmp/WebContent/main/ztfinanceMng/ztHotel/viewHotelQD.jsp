...
<div id="bm-table">
 ...
 collapse;table-layout:fixed;width:441pt'>
  ...
  height:14.25pt'>酒店名称：</td>
  <td colspan=5 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("hklist","hotel_name",0)%></td>
 </tr>
  <tr height=25 style='mso-height-source:userset;height:20pt'>
  <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>签单总计：</td>
  <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("hklist","qdxj",0) %></td>
   <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>团号：</td>
  <td colspan=5 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("hklist","tid",0)%></td>
 </tr>
				
			<%
		int rows = rd.getTableRowsCount("hklist");
		for(int i=0;i<rows;i++) {
			String tid = rd.getStringByDI("hklist","id",i);
			String id = rd.getStringByDI("hklist","hotel_id",i);//团号
			String city = rd.getStringByDI("hklist","hotel_name",i);//城市
			String jd = rd.getStringByDI("hklist","hotel_address",i);//酒店
			String qdxj = rd.getStringByDI("hklist","qdxj",i);//签单小计
			String hkje=rd.getStringByDI("hklist","hkje",i);
			String czrq=rd.getStringByDI("hklist","czrq",i);
			String ye=rd.getStringByDI("hklist","ye",i);

		%>
			
			<tr height=25 style='height:20pt'>
  			<td class=xl25 >已签清单：</td>
