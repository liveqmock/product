...
<script type="text/javascript">
	...
	function addJingDQD(){
		...
		{
		jQuery("#ye").val(parseInt(qd-xf));
		document.qiandan_form.action="addJingDqingdan.";
...
<div id="bm-table">
 ...
 width="95%" id="hotel0">
			...
			<tr><td colspan=1 >景点名称：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxJingD","cmpny_name",0)%>"  readonly="readonly"  / ></td></tr>  
			<tr><td colspan=1 >团号：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxJingD","id",0)%>"  readonly="readonly"  / ></td></tr>
			
			<tr><td>签单总计：</td><td><input type="text"  id="hj" value="<%=rd.getStringByDI("selectBxJingD","qdxj",0) %> "  readonly="readonly"  / >/元</td></tr>
			...
			<tr>	
				<td><font color="red">现付金额：</font></td><td><input type="text" value="" name="TA_ZT_QDQKJL4JD/HKJE[0]" id="xf" onkeydown="checkNum()" onchange="sumRs()"  class="xfxj"/>/元
				</td>		
			</tr>
			<tr >
				<td><font color="red">余额：</font></td><td><input type="text" value="" name="TA_ZT_QDQKJL4JD/YE[0]" value="" readonly="readonly" id="ye" class="yue" />/元
				</td>
			</tr>
			<tr >
				<td colspan="">
			<input type="hidden" name="TA_ZT_QDQKJL4JD/TID[0]" value="<%=rd.getStringByDI("selectBxJingD","id",0)%>"/>
			<input type="hidden" name="TA_ZT_QDQKJL4JD/SFID[0]" value="<%=rd.getStringByDI("selectBxJingD","sfid",0)%>"/>
			<input type="hidden" name="TA_ZT_QDQKJL4JD/CSID[0]" value="<%=rd.getStringByDI("selectBxJingD","csid",0)%>"/>
			<input type="hidden" name="TA_ZT_QDQKJL4JD/JDID[0]" value="<%=rd.getStringByDI("selectBxJingD","scenery_id",0)%>"/>
			<input type="hidden" name="TA_ZT_QDQKJL4JD/CZR[0]" value="<%=sd.getString("userno") %>"/>	
				</td>
			</tr>
