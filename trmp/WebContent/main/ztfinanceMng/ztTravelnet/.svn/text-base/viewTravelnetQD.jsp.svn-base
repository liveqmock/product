...
<div id="bm-table">
 ...
 collapse;table-layout:fixed;width:441pt'>
  ...
  height:14.25pt'>地接名称：</td>
  <td colspan=5 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'><%=rd.getStringByDI("trlist","cmpny_name",0)%></td>
 </tr>
  <tr height=25 style='mso-height-source:userset;height:20pt'>
  <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  ...
  height:14.25pt'>
  <%=rd.getStringByDI("trlist","qdje",0) %></td>
   <td colspan=1 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>团号：</td>
     <td colspan=2 height=19 class=xl31 style='border-right:.5pt solid black;
  height:14.25pt'>
  <%=rd.getStringByDI("trlist","tid",0)%></td>
 </tr>
				
			<%
		int rows = rd.getTableRowsCount("trlist");
		for(int i=0;i<rows;i++) {
			String hkje=rd.getStringByDI("trlist","hkje",i);
			String czrq=rd.getStringByDI("trlist","czrq",i);
			String ye=rd.getStringByDI("trlist","ye",i);
