...
function findByLike1(){//tab1 查询action
	document.zt_cwdz_form1.action="CwdzInfo1.?userno=&state=0&pageSize=10&pageNO=1";
	document.zt_cwdz_form1.submit();
}
function findByLike2(){//tab2 查询action
	document.zt_cwdz_form2.action="CwdzInfo2.?dzzt=dzz&state=1&pageSize=10&pageNO=1";
	document.zt_cwdz_form2.submit();
}
function findByLike3(){//tab3 查询action
	document.zt_cwdz_form3.action="CwdzInfo3.?dzzt=yczd&state=2&pageSize=10&pageNO=1";
	document.zt_cwdz_form3.submit();
}
function cwdzSubmit1(DDH){//tab1 提交订单 action
	document.zt_cwdz_form1.action="CwdzSubmit1.?pageSize=10&pageNO=1&DDH="+DDH;
	document.zt_cwdz_form1.submit();
}
...
function openPeople1(iName,groupId){
	if( $("#"+iName+" .groupTd div").size()==0){
		 var obj=$.ajax({
		 	 url:"showYkorderWdzzdList.?groupId="+groupId+"&state=0",
			 async:true,
			 dataType:"HTML",
			 cache:false,
			 success:function(){
...
function openPeople2(iName,groupId){
	if( $("#"+iName+" .groupTd div").size()==0){
		 var obj=$.ajax({
		 	 url:"showYkorderDzzdList.?groupId="+groupId+"&state=1",
			 async:true,
			 dataType:"HTML",
			 cache:false,
			 success:function(){
...
function openPeople3(iName,groupId){
	if( $("#"+iName+" .groupTd div").size()==0){
		 var obj=$.ajax({
		 	 url:"showYkorderYczdList.?groupId="+groupId+"&state=2",
			 async:true,
			 dataType:"HTML",
			 cache:false,
			 success:function(){
...
<div class="ui-widget" >
	...
	<div id="page">
		<%String url=request.getContextPath()+"/main/moneyMng/account/CwdzInfo.?pageSize=10&pageNO=";%>
...
<table class="datas" >
	...
	<div id="page">
		<%String url2=request.getContextPath()+"/main/moneyMng/account/CwdzInfo2.?pageSize=10&pageNO=";%>
...
<table class="datas" >
	...
	<div id="page">
		<%String url3=request.getContextPath()+"/main/moneyMng/account/CwdzInfo3.?pageSize=10&pageNO=";%>
