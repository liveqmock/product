...
%>
		...
		<tr>
				...
				<td align="center">
					...
					for(int j = 0; j < pRows; j++){
						%>
							...
							<%=rd.getStringByDI("rsCwdzPriceInfo", "person_count", j) %>人-
				...
				<td>
				意见：<input type="text" name="DDH<%=DDH %>/SPYJ" size="30"/><br>
					<%
				...
				<td align="center">
						<input type="radio" value="Y" name="SPZT<%=DDH %>/TGZT" checked="checked"/>通过
         		&nbsp;<input type="radio" value="N" name="SPZT<%=DDH %>/TGZT"/>不通过
         		<input type="button" value="提交" onclick="cwdzSubmit2('<%=DDH %>');" />
				</td>
		</tr>
