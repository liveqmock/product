...
function selectChange(id){
	...
	function addNewRow() {
		...
		td1.innerHTML="<select name='TA_ZT_LINE_PRICES/price_type["+lineNo+"]'>"+
		               ...
		               %>
		               "</select>";
		td2.innerHTML="<input name='TA_ZT_LINE_PRICES/PRICE_TH["+lineNo+"]' value='0' class='smallInput' maxlength='12' id='price_th"+lineNo+"'/>";
		td3.innerHTML="<input name='TA_ZT_LINE_PRICES/PRICE_ms["+lineNo+"]' value='0' class='smallInput' maxlength='12'/>";
		td4.innerHTML="<input name='TA_ZT_LINE_PRICES/PRICE_zd["+lineNo+"]' value='0' class='smallInput' maxlength='12'/>";
...
function addRow_jhdd(){
		...
		$("#jhdd_tab").append('<tr><td>'+
				...
				'<td><input type="text" name="TA_ZT_GATHER/ADD_M_COUNT['+num+']" id="addMCount'+num+'" value="0" onkeydown="checkNum()"/>'+
