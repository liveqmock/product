...
<div id="lable"><span>单据打印列表</span></div>
...
<div id="list-table">
	<table class="datas" >
		...
		<tr>
			...
			<td align="left">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="###" onclick="return GB_myShow('','<%=request.getContextPath() %>/main/ztPlans/printGroupPlan/ztshowGroupPrint.?TA_ZT_GROUP/ID=<%=ID %>&TA_TDJDXXZJB_ZT/TID=<%=ID %>&id=<%=ID %>','1000','850')"><img alt="" src="<%=request.getContextPath() %>/images/Print.gif">&nbsp;[打印出团任务单]</a><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="###" onclick="return GB_myShow('','printYkmd.?groupID=<%=ID %>','1000','850');"><img alt="" src="<%=request.getContextPath() %>/images/Print.gif">&nbsp;[打印游客名单]</a><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="###" onclick="return GB_myShow1('','viewTravelList.?groupId=<%=ID %>&lineId=<%=XLID %>');"><img alt="" src="<%=request.getContextPath() %>/images/Print.gif">&nbsp;[打印行程单]</a><br>
			</td>
		</tr>
		<%} %>
	</table>
