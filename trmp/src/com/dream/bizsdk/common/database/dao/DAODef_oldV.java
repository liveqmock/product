...
public class DAODef_oldV {
     ...
     * @param driver
     */
    public DAODef_oldV(String name, String dbURL, String dbType, String dbUser
                  , String dbPassword, String driver) {
        _name = name;
        _dbURL = dbURL;
        _dbType = dbType;
        _dbUser = dbUser;
     ...
     * @param usingJTA
     */
    public DAODef_oldV(String name, String dbType, String dataSource, boolean usingJTA, boolean overrideUser, boolean twoPhaseCommit
     ...
     */
    public DAODef_oldV(String name, String dbURL, String dbType, String dbUser
                  , String dbPassword, int conns, String driver) {
        _name = name;
        _dbURL = dbURL;
        _dbType = dbType;
        _dbUser = dbUser;
